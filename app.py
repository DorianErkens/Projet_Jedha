...
st.write("""The content is desgined in 4 steps :
                *1. Data Geography
                *2. Data Exploration
...
def choose_ur_graph():
    x_value = st.selectbox("What do you want to see on the x scale ?", data.columns)
    y_value = st.selectbox("What do you want to see on the y scale ?", data.columns)
...
variable = st.selectbox("What trend across time do you want to explore ?", data.columns)
